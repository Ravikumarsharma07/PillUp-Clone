const OurVisionBS = () => {
    return (
      <section className="bg-red-400 h-[100vh]  max-sm:py-0 box-content flex flex-row-reverse max-sm:flex-col-reverse justify-center sm:justify-end items-center">
        ...
        <img className="w-[360px] max-sm:h-[330px] sm:w-[50%] max-h-full object-cover" src="https://pillup.com/assets/BrandStory/vissionImg.jpg" alt="medicine in hand" />
      </section>
    );
  };
