const OurMissionBS = () => {
  return (
    <section className="bg-orange-50 h-screen max-sm:h-max max-sm:pt-16 box-content flex max-sm:flex-col-reverse justify-center sm:justify-end items-center">
      ...
      <img className="w-[80%] max-sm:max-w-[360px] max-sm:h-[330px] sm:w-[50%] max-h-full object-cover" src="https://pillup.com/assets/BrandStory/missionImg1.jpg" alt="flower" />
    </section>
  );
};
